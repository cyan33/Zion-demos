...
/***/ (function(module, exports) {
    ...
    var _KeyBus = __webpack_require__(49);
    
    var _KeyBus2 = _interopRequireDefault(_KeyBus);
    ...
    var SnakeGame = function (_Game) {
        ...
        _createClass(SnakeGame, [{
            ...
            value: function initNetwork() {
                ...
                var kb = new _KeyBus2.default(document);
    
                kb.down(13, function () {
                    var val = Math.random().toFixed(2);
                    socket.emit('player-press-enter', val);
                });
                socket.on('player-press-enter', function (ran) {
    ...
    */
    ...
    var KeyBus = function () {
      function KeyBus(target) {
        _classCallCheck(this, KeyBus);
      ...
      _createClass(KeyBus, [{
        key: 'enableMultiKey',
        value: function enableMultiKey() {
          this.enableMultiKey = true;
          this.keyhash = {};
        }
      }, {
        key: 'disableMultiKey',
        value: function disableMultiKey() {
          this.enableMultiKey = false;
          this.keyhash = null;
        }
      }, {
        ...
        key: 'down',
        value: function down(keyCode, cb) {
        ...
        key: 'simulDown',
        value: function simulDown(keyCode, cb) {
          this.simulDownListeners[keyCode] ? this.simulDownListeners[keyCode] = [cb] : this.simulDownListeners[keyCode].push(cb);
        ...
        key: 'executeMultiKeyHandlers',
        value: function executeMultiKeyHandlers() {
          for (var key in this.simulDownListeners) {
            if (this.keyhash[key]) {
              this.simulDownListeners[key].forEach(function (cb) {
                cb();
              });
            }
          }
